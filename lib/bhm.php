    ...
    $uid=date('ymd').$dopol.$val+1;
        ...
        if($sms->auth())
        {
           $phone_who=$_POST['phone'];
            $sms->sendsms('lyufari',$phone_who,'Спасибо. Бронь # ".$uid." "'.$typenomertext.'"\nМы свяжемся с вами в ближайшее время.');

//            $sms->sendsms('lyufari','+380954570088',"Бронь на «".$typenomertext."» на сумму ".$itogo." грн");
            $sms->sendsms('lyufari','+380505870147','Бронь "'.$typenomertext.'" на сумму '.$itogo.' грн');
            $sms->sendsms('lyufari','+380951727272','Бронь "'.$typenomertext.'" на сумму '.$itogo.' грн');
